...
###this is personal data, input as required###
client_id = ""
client_secret = ""
redirect_uri = ""
...
class GetPlaylistTracks:
    ...
    def __init__(self, playlist_id, start_of_track_range, end_of_track_range = None):
        self.playlist_id = playlist_id
        self.start_of_track_range = start_of_track_range
        self.end_of_track_range = end_of_track_range
        self.track_list = []
        self.uri_list = []
    ...
    def get_playlist_items(self):
        ...
        for idx, item in enumerate(tracks[self.start_of_track_range:self.end_of_track_range]):
            track = item['track']
